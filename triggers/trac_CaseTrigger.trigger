...
trigger trac_CaseTrigger on Case (after insert, after update, before update, before insert) {
    try {
        if (Trigger.isBefore) {
            if (Trigger.isInsert) {
                trac_CaseTriggerHelper.updateCaseStewardIfChecked(Trigger.new);
                ...
                //trac_CaseTriggerHelper.updateCasePriority(Trigger.new, null);
                ...
                //trac_CaseTriggerHelper.updateCasePriority(Trigger.new, Trigger.oldMap);
